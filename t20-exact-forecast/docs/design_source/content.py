...
BLOCKS = [
    ...
    ("plate", "system_overview", "Plate 1. The whole system", "Five zones: calibration from the real archive, the synthetic world that holds the hidden state, the task build and packaging, the Harbor runtime with its separate agent and verifier containers, and the research evidence behind the pass bar."),
